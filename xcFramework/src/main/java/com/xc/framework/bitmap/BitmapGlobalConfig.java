...
import com.xc.framework.bitmap.core.BitmapCache;
import com.xc.framework.bitmap.download.DefaultDownloader;
...
public class BitmapGlobalConfig {
	...
	public synchronized static BitmapGlobalConfig getInstance(Context context, String diskCachePath) {
		...
		if (TextUtils.isEmpty(diskCachePath)) {
			diskCachePath = BitmapOtherUtil.getDiskCacheDir(context, "xcBitmapCache");
		}

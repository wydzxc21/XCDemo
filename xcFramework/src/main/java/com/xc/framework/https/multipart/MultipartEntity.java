...
import com.xc.framework.https.client.UploadEntity;
	...
	public static class CallBackInfo {
		...
		public boolean doCallBack(boolean forceUpdateUI) {
			if (uploadCallBack != null) {
				uploadCallBack.onLoading(totalLength, pos);
			}
			return true;
		}
	}
